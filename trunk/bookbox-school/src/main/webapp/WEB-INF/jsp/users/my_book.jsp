...
<head>
	...
	function upCallback(page){
		...
		common.getData(common.basePath +"/api/mybook", {"curPage": page.num, "pageSize": page.size}, function(data){
			if(data.success){
				var curPageData = data.models.mybookList; // 接口返回的当前页数据列表
	...
	function processList(mybookList){
		var html ='';
		$(mybookList).each(function(i, obj){
