...
public class HttpClientUtil {
     ...
     * @return
     */
    public static String doPost(String rquesturl, String jsonString) {
        HttpPost httpPost = null;
        String result = null;
        try {
            URL url = new URL(rquesturl); //url地址
    ...
    public static void main(String[] args) {
    	String data = "{\"projectJs\":\"http://www.thingjs.com/demos/menu.html?name=uBuilding\"}";
    	System.out.println(doPost("http://www.thingjs.com/api/updatePageView", data));
	}
