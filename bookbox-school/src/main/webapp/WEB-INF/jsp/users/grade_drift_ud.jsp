...
<head>
	...
	function upCallback(page){
		...
		common.getData(common.basePath +"/api/grade/drift/ud",{"curPage": page.num, "pageSize": page.size}, function(data){
			if(data.success){
				var curPageData = data.models.gradeDriftList; 
	...
	function processList(gradeDriftList){
		var html ='';
		$(gradeDriftList).each(function(i, obj){
